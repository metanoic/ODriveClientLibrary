namespace ODrive
{
    ...
    {
        public DeviceCan(Connection connection): base(connection)
        {
        }
        ...
        public byte NodeId
        {
            get
            {
                var result = FetchEndpointSync<byte>(238);
        ...
        public uint TxMailboxCompleteCallbackCnt
        {
            get
            {
                var result = FetchEndpointSync<uint>(239);
        ...
        public uint TxMailboxAbortCallbackCnt
        {
            get
            {
                var result = FetchEndpointSync<uint>(240);
        ...
        public uint ReceivedMsgCnt
        {
            get
            {
                var result = FetchEndpointSync<uint>(241);
        ...
        public uint ReceivedAck
        {
            get
            {
                var result = FetchEndpointSync<uint>(242);
        ...
        public uint UnexpectedErrors
        {
            get
            {
                var result = FetchEndpointSync<uint>(243);
        ...
        public uint UnhandledMessages
        {
            get
            {
                var result = FetchEndpointSync<uint>(244);
