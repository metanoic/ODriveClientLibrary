namespace ODrive
{
    ...
    public partial class Motor1GateDriver : RemoteObject
    {
        ...
        public int DrvFault
        {
            get
            {
                var result = ODriveDevice.FetchEndpointSync<int>(158);
            ...
            set
            {
                ODriveDevice.FetchEndpointSync<int>(158, value);
        ...
        public ushort StatusReg1
        {
            get
            {
                var result = ODriveDevice.FetchEndpointSync<ushort>(159);
            ...
            set
            {
                ODriveDevice.FetchEndpointSync<ushort>(159, value);
        ...
        public ushort StatusReg2
        {
            get
            {
                var result = ODriveDevice.FetchEndpointSync<ushort>(160);
            ...
            set
            {
                ODriveDevice.FetchEndpointSync<ushort>(160, value);
        ...
        public ushort CtrlReg1
        {
            get
            {
                var result = ODriveDevice.FetchEndpointSync<ushort>(161);
            ...
            set
            {
                ODriveDevice.FetchEndpointSync<ushort>(161, value);
        ...
        public ushort CtrlReg2
        {
            get
            {
                var result = ODriveDevice.FetchEndpointSync<ushort>(162);
            ...
            set
            {
                ODriveDevice.FetchEndpointSync<ushort>(162, value);
